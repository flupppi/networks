  ...
  'syms': { 'networks.abgabe03': { 'networks.abgabe03.calculate_condition_numbers': ( 'abgabe_blatt_3_kalchschmid_wenzler.html#calculate_condition_numbers',
            ...
            'networks.networkanalysis': { 'networks.networkanalysis.draw_trees': ( 'network_analysis.html#draw_trees',
                                          ...
                                          'networks.networkanalysis.update_graph': ( 'network_analysis.html#update_graph',
                                                                                     'networks/networkanalysis.py')},
            'networks.networks03': { 'networks.networks03.categorize_assortativity': ( 'network_analysis_exercise_03.html#categorize_assortativity',
                                                                                       'networks/networks03.py'),
                                     'networks.networks03.clustered_core_with_isolates': ( 'network_analysis_exercise_03.html#clustered_core_with_isolates',
                                                                                           'networks/networks03.py'),
                                     'networks.networks03.fit_degree_connectivity': ( 'network_analysis_exercise_03.html#fit_degree_connectivity',
                                                                                      'networks/networks03.py'),
                                     'networks.networks03.plot_linregress_comparison': ( 'network_analysis_exercise_03.html#plot_linregress_comparison',
                                                                                         'networks/networks03.py'),
                                     'networks.networks03.power_law': ( 'network_analysis_exercise_03.html#power_law',
                                                                        'networks/networks03.py'),
                                     'networks.networks03.randomize_and_measure': ( 'network_analysis_exercise_03.html#randomize_and_measure',
                                                                                    'networks/networks03.py')},
